export const initialReports = [
  // Location 1: 5 reports (RED marker) - High traffic intersection
  {
    ...
    location: "西大路 & 林森路口",
    coordinates: { lat: 24.8005, lng: 120.9665 },
    severity: "high",
    status: "pending",
    reportedBy: "user123",
  ...
  // Location 2: 3 reports (YELLOW marker) - School area
  {
    ...
    location: "西大路 & 文昌街口",
    coordinates: { lat: 24.8010, lng: 120.9655 },
    severity: "medium",
    status: "verified",
  ...
  // Location 4: 2 reports (GREEN marker) - Residential area
  {
    ...
    location: "西大路 & 建國路口",
    coordinates: { lat: 24.8000, lng: 120.9650 },
    severity: "medium",
    status: "pending",
  ...
  // Location 5: 1 report (GREEN marker) - Park area
  {
    ...
    location: "西大路 & 公園路口",
    coordinates: { lat: 24.8015, lng: 120.9670 },
    severity: "low",
    status: "pending",
  ...
  // Location 6: 6 reports (RED marker) - Busy commercial area
  {
    ...
    location: "西大路 & 商業街口",
    coordinates: { lat: 24.7990, lng: 120.9675 },
    severity: "high",
    status: "pending",
